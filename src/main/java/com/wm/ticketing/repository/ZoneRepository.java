...
public class ZoneRepository {
	...
	private void setupData() {
		...
		Zone zone1=new Zone(1, "Orchestra", 2, new BigDecimal(200));
		zone1.setVenue(theater);
		Zone zone2= new Zone(2, "Mezzanine", 3, new BigDecimal(150));
	...
	public int getAvailableSeatCount(int zoneId) {
		...
		System.out.println("Zones size:" + zones.size());
		...
		System.out.println("Avail seats:" + availableSeatsCount);
